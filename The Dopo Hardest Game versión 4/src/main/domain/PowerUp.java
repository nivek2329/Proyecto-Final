...
public abstract class PowerUp implements GridEntity {
    ...
    /**
     * Restaura el estado de consumo desde una partida guardada.
     *
     * @param wasConsumed indica si el power-up ya había sido consumido
     */
     ...
     *
     * @return true si el power-up ya fue consumido
     */
