...
public abstract class Player implements GridEntity {
     ...
     * @param newDeaths          acumulado de muertes a restaurar
     * @param newExtraLives      acumulado de vidas extra a restaurar
     * @param newHitImmunityTicks ticks restantes de inmunidad por golpe
     */
