...
public class BasicEnemy extends Enemy {
    ...
    /**
     * Restaura posición, vector de dirección y ticks desde una partida guardada.
     *
     * @param newRow      nueva fila del enemigo básico
     * @param newCol      nueva columna del enemigo básico
    ...
    /**
     * Crea una instantánea del estado de movimiento del enemigo básico.
     *
     * @return instantánea del estado del enemigo básico
     */
