...
public final class GameGUI extends JFrame {
    ...
    private void handleGameError(final String operation, final Exception ex) {
        ...
        if (ex instanceof HardestGameException) {
            ...
            ErrorReportDialog.show(this, lastConfig, ex);
        }
        game.prepareForLoad();
    }
    ...
    /**
     * Punto de entrada principal para iniciar la aplicación del juego.
     * Configura el manejador de excepciones no controladas y arranca la interfaz gráfica.
     *
     * @param args argumentos de línea de comandos (no utilizados)
     */
    public static void main(final String[] args) {
        Thread.setDefaultUncaughtExceptionHandler((thread, throwable) -> {
            // Registrar el crash en el log utilizando GameLogger
            GameLogger.logError("Crash/Error no controlado en hilo: " + thread.getName(), throwable);

            // Abrir automáticamente el diálogo de reporte de error en el EDT
