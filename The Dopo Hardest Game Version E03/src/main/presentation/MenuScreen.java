...
public final class MenuScreen extends JPanel {
    ...
    private final Runnable onLoadSave;
     ...
     * @param onLoadSave acción al presionar CARGAR PARTIDA
     */
    public MenuScreen(final Consumer<GameSetup> onStart, final Runnable onLoadSave) {
    ...
    private void buildComponents() {
        ...
        nivelCombo = makeCombo(new String[]{
            ...
            "Nivel supremo (desafío final)",
            "Gemas del pasillo (medio)",
            "Relámpago (rápido)",
            "Duelo espejo (PvP)"
        });
        ...
        placeMenuButton("CARGAR\nPARTIDA",  590, 592, e -> onLoadSave.run());
