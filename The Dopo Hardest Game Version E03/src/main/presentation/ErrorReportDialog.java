...
public final class ErrorReportDialog extends JDialog {
    ...
    private ErrorReportDialog(final Window owner, final String levelContext) {
        super(owner, "Reportar problema", ModalityType.APPLICATION_MODAL);
    ...
    /**
     * Crea y muestra el diálogo de reporte de error.
     *
    ...
    public static void show(final Window owner, final String levelContext) {
        final ErrorReportDialog dlg = new ErrorReportDialog(owner, levelContext);
        dlg.setVisible(true);
    }
    ...
    private JPanel buildHeader() {
        ...
        final JLabel icon = new JLabel("⚠  Reportar problema", SwingConstants.LEFT);
