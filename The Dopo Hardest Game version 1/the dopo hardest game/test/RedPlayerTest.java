 ...
 *
 * @return conjunto de pruebas unitarias para el jugador rojo
 * @author Angel-Garcia
 * @date 2026-1
 */
public class RedPlayerTest {
    ...
    /**
     * @return inicialización del jugador y del tablero antes de cada prueba
     */
    @Before
    public void setUp() {
        board = new Board(5, 5);
    ...
    /**
     * @return liberación de recursos después de cada prueba
     */
    @After
    ...
    /**
     * @return verificación de que el jugador no atraviesa muros al desplazarse
     */
    @Test
    public void shouldNotMoveRespetaPared() {
        board.setWall(2, 2);
    ...
    /**
     * @return comprobación de reaparición del jugador en el centro de una zona
     */
    @Test
    ...
    /**
     * @return verificación del color del jugador rojo
     */
    @Test
    ...
    /**
     * @return comprobación del nombre del jugador rojo
     */
    @Test
    ...
    /**
     * @return verificación del tamaño relativo del jugador rojo
     */
    @Test
