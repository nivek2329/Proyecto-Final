 ...
 *
 * @return conjunto de pruebas unitarias para el enemigo básico
 * @author Angel-Garcia
 * @date 2026-1
 */
public class BasicEnemyTest {
    ...
    /**
     * @return verificación del avance horizontal del enemigo tras cuatro ticks
     */
    @Test
    public void shouldHorizontalIzquierdaAvanzaDespuesDeCuatroTicks() {
    ...
    /**
     * @return comprobación de rebote horizontal del enemigo al colisionar con un muro
     */
    @Test
    public void shouldHorizontalRebotaEnPared() {
        board.setWall(1, 9);
    ...
    /**
     * @return verificación de que el enemigo no entra en zonas seguras
     */
    @Test
    public void shouldNotHorizontalEntraEnZonaVerdeEnemigo() {
    ...
    /**
     * @return comprobación del movimiento vertical del enemigo tras los ticks requeridos
     */
    @Test
    ...
    /**
     * @return verificación de que el enemigo tenga un color válido
     */
    @Test
