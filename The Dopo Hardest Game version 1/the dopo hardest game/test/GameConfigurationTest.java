 ...
 *
 * @return conjunto de pruebas unitarias para la configuración de niveles
 * @author Angel-Garcia
 * @date 2026-1
 */
public class GameConfigurationTest {
    ...
    /**
     * @return inicialización del cargador de configuración antes de cada prueba
     */
    @Before
    public void setUp() {
    ...
    /**
     * @return liberación del cargador de configuración después de cada prueba
     */
    @After
    ...
    /**
     * @return verificación de carga correcta de un archivo de configuración mínimo
     */
    @Test
    ...
    /**
     * @return comprobación de lectura correcta de direcciones horizontales LEFT y RIGHT
     */
    @Test
    ...
    /**
     * @return lanzamiento de excepción cuando falta la zona segura inicial
     */
