 ...
 *
 * @return conjunto de pruebas unitarias para el tablero del juego
 * @author Angel-Garcia
 * @date 2026-1
 */
public class BoardTest {
    ...
    /**
     * @return inicialización del tablero antes de cada prueba
     */
    @Before
    public void setUp() {
    ...
    /**
     * @return liberación del tablero después de cada prueba
     */
    @After
    ...
    /**
     * @return verificación de dimensiones y validación correcta de los límites del tablero
     */
    @Test
    ...
    /**
     * @return comprobación de que un muro impide posiciones válidas para el jugador
     */
    @Test
    public void shouldNotMuroImpidePosicionValidaJugador() {
        board.setWall(2, 2);
    ...
    /**
     * @return verificación de que las zonas prohibidas para enemigos no afectan al jugador
     */
    @Test
    public void shouldZonaProhibidaEnemigoNoEsMuroParaJugador() {
    ...
    /**
     * @return verificación de que fuera de los límites no se registran zonas prohibidas
     */
    @Test
    ...
    /**
     * @return comprobación de que una celda no marcada no es zona prohibida
     */
    @Test
    ...
    /**
     * @return verificación de que no se colocan muros fuera de los límites del tablero
     */
    @Test
    public void shouldNotSetWallOutOfBounds() {
        board.setWall(-1, 0);
        board.setWall(0, -1);
        assertFalse("(0,0) no debe convertirse en muro por llamadas fuera de bounds",
                board.isWall(0, 0));
    }
}