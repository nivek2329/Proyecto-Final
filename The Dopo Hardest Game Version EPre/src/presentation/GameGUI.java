...
public final class GameGUI extends JFrame {
    ...
    private void showMenu() {
        ...
        removeKeyListeners();
        add(new MenuScreen(this::startGame), BorderLayout.CENTER);
        pack();
    ...
    private void updateStatus() {
        ...
        statusLabel.setText(String.format(
                game.isTwoPlayerMode()
                        ? "  J1 Muertes: %d  |  J2 Muertes: %d  |  Monedas: %d / %d  |  Tiempo: %ds"
                        : "  Muertes: %d  |  Monedas: %d / %d  |  Tiempo: %ds",
                game.getDeaths(),
                game.isTwoPlayerMode() ? game.getSecondPlayerDeaths() : 0,
