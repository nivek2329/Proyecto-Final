...
public class BoardTest {
     ...
     */
    @Test
    public void shouldNotMuroImpidePosicionValidaJugador() throws Exception {
        board.setWall(2, 2);
     ...
     */
    @Test
    public void shouldZonaProhibidaEnemigoNoEsMuroParaJugador() throws Exception {
    ...
    public void shouldNotSetWallOutOfBounds() throws Exception {
        board.setWall(-1, 0);
    }
}
