...
public class Zone {
    ...
    /**
     * Define los tipos funcionales posibles para una zona.
     */
    public enum Type { 
        /** Zona de inicio segura. */
        INITIAL, 
        /** Zona de control o checkpoint segura intermedia. */
        INTERMEDIATE, 
        /** Zona final segura para alcanzar la victoria. */
        FINAL 
    }
     ...
     * @return true si la posición está dentro de los límites de la zona; false en caso contrario
     */
