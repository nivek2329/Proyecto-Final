...
public class GreenPlayer extends Player {
     ...
     *
     * @return true si el golpe fue absorbido (no debe morir); false si debe morir normalmente
     */
     ...
     *
     * @return true si aún puede absorber un golpe; false en caso contrario
     */
     ...
     *
     * @return true si ignora colisiones de enemigo por unos ticks; false en caso contrario
     */
     ...
     *
     * @return true si no puede recibir daño en este momento; false en caso contrario
     */
     ...
     *
     * @param shield determina si el escudo estaba activo
     * @param invulnTicks ticks de invulnerabilidad restantes
     */
    public void restoreGreenSavedState(final boolean shield, final int invulnTicks) {
        shieldActive = shield;
     ...
     *
     * @return número de ticks de invulnerabilidad restantes
     */
    public int getInvulnerableTicksForSave() {
     ...
     *
     * @return color verde (Color.GREEN)
     */
    @Override 
     ...
     *
     * @return nombre del jugador ("Clyde")
     */
    @Override 
