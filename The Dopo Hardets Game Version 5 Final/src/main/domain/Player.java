 ...
 * Define la posición, vidas, muertes e inmunidades comunes a todas las variantes de jugador.
 *
 * @author Angel-Garcia
 * @version 2026-1
 */
public abstract class Player implements GridEntity {
    ...
    /** Ticks de inmunidad tras absorber un golpe mediante vida extra. */
     ...
     *
     * @return true si se consumió una vida extra; false en caso contrario
     */
     ...
     *
     * @return true si no debe recibir daño letal; false en caso contrario
     */
    ...
    /**
     * Restaura la posición y las estadísticas del jugador desde una partida guardada.
     *
     * @param newRow nueva fila del jugador
     * @param newCol nueva columna del jugador
     * @param newDeaths número de muertes cargado
     * @param newExtraLives número de vidas extra cargado
     * @param newHitImmunityTicks ticks de inmunidad cargados
     */
